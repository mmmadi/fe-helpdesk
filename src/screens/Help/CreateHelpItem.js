...
export const CreateHelpItem = () => {
  ...
  const addHelpItemHandler = () => {
    dispatch(createHelpItem(name, categoryId, text, files));
    history.push("/help");
  };
  ...
  return (
    <div className="layout-container">
      ...
      <div className="layout-content">
        <div className="create-help-item-section container-fluid flex-grow-1 container-p-y">
          <h4 className="font-weight-bold mb-4">
            <FontAwesomeIcon icon={icons["faGraduationCap"]} className="icon" />
            Создание материала
            <div className="text-muted text-tiny mt-1">
              <small className="font-weight-normal">Новый материал</small>
            </div>
          </h4>
          <div className="row">
